...
6. What .NET target framework? (default: net10.0)
7. What database provider? (default: SQL Server)
8. What identity provider? (default: Okta)
...
15. What message broker if any? (default: WolverineFX - add Azure Service Bus or RabbitMQ if needed)
